...
private:
    ...
    void deleteHead(Node *givenNode){
        ...
        // Make head point to the new head
        head = givenNode->next;
        delete givenNode;
    ...
    void moveKeyToTail(Node *givenNode){
        ...
        // Any node in the middle of the DLL
...
public:
    ...
    int get(int key){
        ...
        // Else, return the key's value and move this node to the end of the DLL
        moveKeyToTail(it->second);
        return it->second->val;
    }
    // Put pages into the cache
